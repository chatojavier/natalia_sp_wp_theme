...
module.exports = ( projectOptions ) => {
    ...
    */
    ...
    const plugins = [
        ...Base.plugins, ...[
            // Tailwind v3 already removes unused utility classes using tailwind.config.js.
            // Do not run PurgeCSS on the compiled stylesheet: it cannot see every
            // WordPress-generated selector and was stripping this theme's CSS entirely.
        ]
    ]
